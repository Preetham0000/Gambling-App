...
def create_gambler_profile_enhanced(gambler_service, validator):
    """Enhanced gambler profile creation with all features"""
    print("\n" + "="*60)
    ...
    min_required_stake = 100.0  # Fixed minimum
    print(f"Minimum required stake ({min_required_stake:.2f}): {min_required_stake:.2f}")
    ...
    # Game Type
    print("\nPreferred game type (STANDARD): STANDARD")
    game_type = "STANDARD"
...
def display_gambler_profile(gambler_data, gambler_service):
    """Display selected gambler profile in table format"""
    print("\n" + "="*60)
    print("                  SELECTED GAMBLER")
    print("="*60)
    
    gambler = gambler_service.get_gambler(gambler_data['gambler_id'])
    
    # Display as table
    print(f"┌─────────────────────────┬─────────────────────────┐")
    print(f"│ {'Field':<23} │ {'Value':<23} │")
    print(f"├─────────────────────────┼─────────────────────────┤")
    print(f"│ {'ID':<23} │ {gambler_data['gambler_id']:<23} │")
    print(f"│ {'Username':<23} │ {gambler_data['username']:<23} │")
    print(f"│ {'Name':<23} │ {gambler_data['full_name']:<23} │")
    print(f"│ {'Email':<23} │ {gambler_data['email']:<23} │")
    print(f"│ {'Current Stake':<23} │ {gambler_data['initial_stake']:<23.2f} │")
    print(f"│ {'Win Threshold':<23} │ {gambler_data['win_threshold']:<23.2f} │")
    print(f"│ {'Loss Threshold':<23} │ {gambler_data['loss_threshold']:<23.2f} │")
    print(f"│ {'Min Bet':<23} │ {gambler_data['min_bet']:<23.2f} │")
    print(f"│ {'Max Bet':<23} │ {gambler_data['max_bet']:<23.2f} │")
    print(f"│ {'Game Type':<23} │ {gambler_data['game_type']:<23} │")
    print(f"│ {'AutoPlay Enabled':<23} │ {'Yes' if gambler_data['enable_autoplay'] else 'No':<23} │")
    print(f"│ {'AutoPlay Limit':<23} │ {gambler_data['autoplay_limit']:<23} │")
    print(f"│ {'Active':<23} │ {'Yes':<23} │")
    print(f"└─────────────────────────┴─────────────────────────┘")
    
    print(f"\n Profile created successfully. Player ID: {gambler_data['gambler_id']}.")
...
if __name__ == "__main__":
    ...
    while True:
        ...
        if choice == 1:
            ...
            if gambler_data:
                display_gambler_profile(gambler_data, gambler_service)
                break
        elif choice == 2:
